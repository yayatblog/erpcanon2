    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- <li class="nav-item">
        ...
        <!-- <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Custom Gudang:</h6>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('tarifkirim');?>">
        <i class="fas fa-fw fa-chart-bar"></i>
          <span>Tarif Kirim</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('ekspedisi');?>">
          <i class="fas fa-fw fa-atlas"></i>
          <span>Daftar Ekpedisi</span></a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Maulana Hidayat</span>
